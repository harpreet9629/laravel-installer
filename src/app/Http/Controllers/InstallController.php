...
namespace HS\LaravelInstaller\App\Http\Controllers;
...
class InstallController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('HS\LaravelInstaller::install.index', array('fields' => $fields));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('HS\LaravelInstaller::install.store',
            array(
